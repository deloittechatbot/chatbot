...
using TestAssistant1.Adapters;
using TestAssistant1.Authentication;
using TestAssistant1.Bots;
using TestAssistant1.Dialogs;
using TestAssistant1.Services;

namespace TestAssistant1
{
